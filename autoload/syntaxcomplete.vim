...
" CAUTION: I've made some modificatoins in function
"          s:SyntaxCSyntaxGroupItems()
"          
"          The way it removes 'accept_chars'
"
"            let accept_chars = ','.&iskeyword.','
"
"          has some problems.
"
"          For example, if &iskeyword = '@,48-57,_,128-167,224-235',
"          then 224-235 cannot be removed because original sub pattern
"          is ',[^,]\+-[^,]\+,', and the last comma is used in ',128-167,'.

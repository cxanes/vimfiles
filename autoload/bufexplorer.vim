...
" Last Changed: Friday, 02 November 2007
...
" Version number {{{1
let g:bufexplorer_version = "7.1.1"
...
function BufExplorer_Start()
  ...
  call bufexplorer#StartBufExplorer("e")
endfunction
...
" bufexplorer#StartBufExplorer {{{1
function bufexplorer#StartBufExplorer(open)
...
function s:RemoveBuffer(mode)
  ...
  if len(g:bufexplorer#MRUList) == 1
...
function s:Close()
  ...
  let listed = filter(copy(g:bufexplorer#MRUList), "buflisted(v:val)")
...
function s:MRUCmp(line1, line2)
  return index(g:bufexplorer#MRUList, str2nr(a:line1)) - index(g:bufexplorer#MRUList, str2nr(a:line2))
endfunction
...
function s:MRUListShow()
  echomsg "MRUList=".string(g:bufexplorer#MRUList)
endfunction

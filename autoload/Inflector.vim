" Inflector.vim: A wrapper of python module 'Inflector'
" <http://www.bermi.org/inflector/download> (version 0.1)
"
" Last Modified: 2009-03-02 21:41:05
...
function! Inflector#ForeignKey(class_name, ...)
  ...
  let separate_class_name_and_id_with_underscore = a:0 > 0 && !empty(a:1) ? '1' : ''

...
" Load Once {{{
if exists('loaded_FileExplorer_autoload_plugin')
  finish
endif
let loaded_FileExplorer_autoload_plugin = 1
...
"}}}
function! FileExplorer#Open(dir, ...) " ... = max_level [0:Max_Create_Level], otherside {{{

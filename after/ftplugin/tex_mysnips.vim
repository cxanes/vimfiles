...
exe "Snipp rm `escape(snippets#tex#__init__#Font('rm', '{${1}}'), '\\')`"
exe "Snipp tt `escape(snippets#tex#__init__#Font('tt', '{${1}}'), '\\')`"
exe "Snipp bf `escape(snippets#tex#__init__#Font('bf', '{${1}}'), '\\')`"
exe "Snipp sf `escape(snippets#tex#__init__#Font('sf', '{${1}}'), '\\')`"
exe "Snipp it `escape(snippets#tex#__init__#Font('it', '{${1}}'), '\\')`"
exe "Snipp sl \\textsl{${1}}"
